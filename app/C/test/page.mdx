    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'short jest pełnoprawnym typem całkowitym zgodnie ze standardem C.',
        },
        {
            id: 'b',
            ...
            correct: true,
            explanation:
                'Standard C wymaga, aby sizeof(int) był co najmniej równy 2 bajtom, czyli 16 bitom.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'Standard definiuje, że sizeof(char) zawsze wynosi dokładnie 1 bajt.',
        },
        {
            id: 'd',
            ...
            correct: true,
            explanation:
                'Dozwolone są implementacje, w których sizeof(long) == sizeof(int).',
        },
    ]}
/>
...
<QuizQuestion
    ...
    options={[
        ...
        },
        {
            ...
            correct: false,
            explanation:
                'Literały liczbowe są R-wartościami i nie mogą stać po lewej stronie operatora przypisania.',
        },
        {
            id: 'd',
            ...
            correct: false,
            explanation:
                'W C liczby binarne zapisuje się z prefiksem 0b, np. 0b1010.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: true,
            explanation:
                'Preprocesor wykonuje tekstowe wklejenie treści pliku nagłówkowego.',
        },
        {
            id: 'b',
            ...
            correct: true,
            explanation:
                'include jest dyrektywą preprocesora, nie zwykłą instrukcją języka C.',
        },
        {
            id: 'c',
            ...
            correct: false,
            explanation:
                'Nagłówek stdio.h udostępnia deklaracje wielu funkcji, nie tylko printf.',
        },
        {
            id: 'd',
            ...
            correct: false,
            explanation:
                'Kompilator dostaje już kod po przetworzeniu przez preprocesor.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'To poprawny alias typu – String_t oznacza wskaźnik do typu char.',
        },
        {
            id: 'b',
            ...
            correct: false,
            explanation:
                'Po rozwinięciu makra tylko s3 jest wskaźnikiem, s4 jest zwykłym char.',
        },
        {
            id: 'c',
            ...
            correct: false,
            explanation:
                'typedef działa poprawnie, ale define robi podmianę tekstu i zmienne nie mają wszystkich identycznego typu.',
        },
        {
            id: 'd',
            ...
            correct: true,
            explanation:
                'typedef działa na poziomie typów, define to tylko makro tekstowe i bywa źródłem subtelnych błędów.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: true,
            explanation:
                'Rozmiar opiera się na zmiennych const, które nie muszą być stałymi czasu kompilacji, więc tablica może być traktowana jako VLA.',
        },
        {
            id: 'b',
            ...
            correct: false,
            explanation:
                'Nazwa tablicy to adres pierwszego elementu, czyli tab2D[0][0].',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'Rozmiar całkowity tablicy to SIZE_X * SIZE_Y = 3 * 3 = 9 elementów.',
        },
        {
            id: 'd',
            ...
            correct: false,
            explanation:
                'Indeksy tablicy dwuwymiarowej mieszczą się w zakresie 0..2, więc tab2D[3][3] jest poza zakresem.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'Wyrażenie i++ + i++ ma nieokreślony porządek ewaluacji. Wynik jest niedeterministyczny niezależnie od wartości początkowej.',
        },
        {
            id: 'b',
            ...
            correct: false,
            explanation:
                'Standard C nie określa kolejności obliczeń, więc wynik może być różny na różnych kompilatorach.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'Kod modyfikuje zmienną i więcej niż raz pomiędzy punktami sekwencyjnymi, co prowadzi do nieokreślonego zachowania.',
        },
        {
            id: 'd',
            ...
            correct: true,
            explanation:
                'Składniowo kod jest poprawny — problem dotyczy logiki wykonania, nie składni.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'Deklarować trzeba każdą zmienną — także tablice, struktury, wskaźniki itd.',
        },
        {
            id: 'b',
            ...
            correct: false,
            explanation:
                'Deklaracje są elementem języka C — preprocesor ich nie przetwarza.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'Deklaracja wprowadza identyfikator zmiennej do przestrzeni nazw.',
        },
        {
            id: 'd',
            ...
            correct: true,
            explanation:
                'W każdym standardzie C zmienna musi zostać zadeklarowana przed użyciem.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'typedef tworzy alias typu — p2 zachowuje się jak nazwa typu, nie wymaga struct.',
        },
        {
            id: 'b',
        ...
        },
        {
            ...
            correct: true,
            explanation:
                'pc ma pola x i y, a operator . służy do ich ustawiania.',
        },
        {
            id: 'd',
            ...
            correct: false,
            explanation:
                'pa jest wskaźnikiem, a nie strukturą — dopóki nie wskazuje na obiekt, dereferencja jest błędna.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'Wskaźnik przechowuje adres, nie wartość. Może wskazywać na a, ale nie przechowuje jego wartości.',
        },
        {
            id: 'b',
            ...
            correct: false,
            explanation:
                'Typ wskaźnika to const int*, więc może wskazywać tylko na obiekty typu int.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'const dotyczy obiektu wskazywanego, nie wskaźnika — wskaźnik można zmieniać.',
        },
        {
            id: 'd',
            ...
            correct: true,
            explanation:
                'const powoduje, że poprzez wskaźnik nie wolno modyfikować obiektu typu int.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'Zmienne automatyczne bez inicjalizacji mają niezdefiniowaną wartość.',
        },
        {
            id: 'b',
            ...
            correct: true,
            explanation:
                'p1 jest wskaźnikiem do int i może przechowywać adres dowolnej zmiennej typu int.',
        },
        {
            id: 'c',
            ...
            correct: false,
            explanation:
                'Tylko p1 jest wskaźnikiem — p2 jest zwykłą zmienną typu int.',
        },
        {
            id: 'd',
            ...
            correct: true,
            explanation:
                'Deklaracja znajduje się w bloku main, więc zmienne są lokalne.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'Wystarczy prototyp funkcji — implementacja może być w innym pliku.',
        },
        {
            id: 'b',
            ...
            correct: true,
            explanation:
                'Funkcja dostaje tylko wskaźnik — rozmiar nie jest przekazywany automatycznie.',
        },
        {
            id: 'c',
        ...
        },
        {
            ...
            correct: true,
            explanation:
                'Argumenty przekazywane są przez wartość — aby zmodyfikować dane oryginalne, trzeba używać wskaźnika.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: true,
            explanation:
                'Konwencja w C jest taka, że zero oznacza fałsz, a dowolna wartość niezerowa oznacza prawdę.',
        },
        {
            id: 'b',
            ...
            correct: false,
            explanation:
                'Typ bool jest zdefiniowany w nagłówku stdbool.h, nie jest słowem kluczowym takim jak w C++.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'Można napisać if (warunek) instrukcja; else ; i blok else będzie pusty.',
        },
        {
            id: 'd',
            ...
            correct: false,
            explanation:
                'Jeśli w gałęzi if lub else jest tylko jedna instrukcja, klamry nie są wymagane, choć są zalecane ze względów stylu.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: true,
            explanation:
                'Jeżeli lewy operand && jest fałszywy, wynik całego wyrażenia jest fałszywy i prawy operand nie jest obliczany.',
        },
        {
            id: 'b',
            ...
            correct: false,
            explanation:
                'Operator || ma krótkie spięcie, gdy lewy operand jest prawdziwy, prawy może nie zostać obliczony.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'Operator ! zamienia prawdę na fałsz, więc dowolna wartość niezerowa staje się zero.',
        },
        {
            id: 'd',
            ...
            correct: false,
            explanation:
                'W C operator && ma wyższy priorytet niż operator ||, czyli jest obliczany wcześniej.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'Standardowa praktyka to jednokrotne wywołanie srand na początku programu, potem wiele wywołań rand.',
        },
        {
            id: 'b',
            ...
            correct: true,
            explanation:
                'Reszta z dzielenia przez 6 daje wartości od 0 do 5, po dodaniu 1 dostajemy zakres 1 do 6.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'Bez ziarna generator startuje z domyślną stałą wartością i generuje tę samą sekwencję w kolejnych uruchomieniach.',
        },
        {
            id: 'd',
            ...
            correct: false,
            explanation:
                'time(NULL) zwraca czas w sekundach od epoki systemowej, zwykle 1 stycznia 1970.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: true,
            explanation:
                'Pętla porównuje kolejne elementy z aktualnym minimum i aktualizuje indeks gdy znajdzie mniejszy element.',
        },
        {
            id: 'b',
            ...
            correct: true,
            explanation:
                'i jest zwiększane o jeden w każdej iteracji aż osiągnie wartość tabSize, co kończy pętlę.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'Warunek i < tabSize będzie od razu fałszywy, więc ciało pętli nie zostanie wykonane.',
        },
        {
            id: 'd',
            ...
            correct: false,
            explanation:
                'W pętli while warunek sprawdzany jest przed każdą iteracją, nie po.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: true,
            explanation:
                'Warunek w do while jest sprawdzany po wykonaniu ciała pętli.',
        },
        {
            id: 'b',
            ...
            correct: false,
            explanation:
                'Dla tabSize równego 0 zmienna i ma wartość 0, więc odwołanie do tab[i] jest poza zakresem.',
        },
        {
            id: 'c',
            ...
            correct: false,
            explanation:
                'To właśnie odróżnia do while od zwykłego while, warunek jest na końcu.',
        },
        {
            id: 'd',
            ...
            correct: true,
            explanation:
                'Dla tabSize większego od zera obie wersje wyszukują indeks minimum w tablicy.',
        },
    ]}
/>
...
<QuizQuestion
    ...
    options={[
        ...
        },
        {
            ...
            correct: true,
            explanation:
                'continue powoduje przejście do kolejnego obiegu pętli, wykonując wcześniej aktualizację licznika w for.',
        },
        {
            id: 'c',
            ...
            correct: false,
            explanation:
                'Po znalezieniu wartości 3 ustawiamy found na 1, a następnie przerywamy pętlę.',
        },
        {
            id: 'd',
            ...
            correct: true,
            explanation:
                'Częste stosowanie break i continue może utrudniać śledzenie logiki sterowania przepływem w programie.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: true,
            explanation:
                'switch wybiera jedną z gałęzi zależnie od wartości porównywanej.',
        },
        {
            id: 'b',
            ...
            correct: true,
            explanation:
                'Standard C dopuszcza typy całkowite: int, char, enum, long itd.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'Bez break wykonanie spadnie do dalszych case (fallthrough).',
        },
        {
            id: 'd',
    ...
    options={[
        {
            ...
            correct: true,
            explanation:
                'Bez limitu długości scanf może nadpisać pamięć poza tablicą.',
        },
        {
            id: 'b',
            ...
            correct: true,
            explanation:
                'Format ogranicza liczbę wczytywanych znaków, zostawiając miejsce na terminator.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'Zwraca np. 1 gdy sukces, 0 gdy błąd formatu, EOF przy końcu pliku.',
        },
        {
            id: 'd',
            ...
            correct: false,
            explanation:
                '%s wymaga przekazania wskaźnika, a dla liczb należy podać adres zmiennej (&x).',
        },
    ]}
/>
...
<QuizQuestion
    ...
    options={[
        ...
        {
            id: 'b',
            text: 'Użycie getchar() w pętli wymaga czyszczenia bufora aby uniknąć wielokrotnego wykonania iteracji na tym ciągu w buforze.',
            correct: true,
            explanation:
                'Bez czyszczenia bufora enter \n spowodowałby ponowne wejście do pętli.',
        },
        {
            id: 'c',
...
<QuizQuestion
    ...
    options={[
        ...
        },
        {
            ...
            correct: true,
            explanation:
                'Najpierw wykonuje się dzielenie, potem dodawanie/odejmowanie.',
        },
        {
            id: 'c',
            ...
            correct: false,
            explanation:
                'Zmienna b jest modyfikowana i odczytywana w złożonym kontekście, ale główny problem dotyczy e i c — różne punkty sekwencyjne.',
        },
        {
            id: 'd',
            ...
            correct: true,
            explanation:
                'Zgodnie ze standardami kodowania — takie wyrażenia obniżają czytelność i mogą prowadzić do błędów.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: true,
            explanation:
                'Prototyp musi być widoczny przed użyciem (wywołaniem). Bez niego kompilator przyjmie domyślnie `int`, co może prowadzić do cichych błędów, jeśli typ zwracany jest inny.',
        },
        {
            id: 'b',
            ...
            correct: false,
            explanation:
                'Prototyp jest potrzebny zawsze, gdy wywołanie następuje przed definicją. Stwierdzenie to wprowadza w błąd, sugerując, że sekwencyjne ułożenie w jednym pliku zwalnia z obowiązku prototypowania, co jest błędem, jeśli funkcja wywoływana jest po prostu niżej w pliku źródłowym niż funkcja wywołująca.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'Język C zezwala na zwrócenie tylko jednej wartości, chociaż może to być struktura agregująca wiele pól.',
        },
        {
            id: 'd',
            ...
            correct: true,
            explanation:
                'Jest to klasyczna pułapka języka C. Brak argumentów musi być jawnie wskazany przez `(void)`, inaczej kompilator C (nie C++) przyjmie nieznaną listę argumentów.',
        },
    ]}
/>
...
<QuizQuestion
    ...
    options={[
        ...
        },
        {
            ...
            correct: false,
            explanation:
                'To zła praktyka — prowadzi do zależności i trudnych do śledzenia błędów.',
        },
        {
            id: 'c',
            ...
            correct: true,
            explanation:
                'O ile nie są oznaczone const, mogą być zmieniane przez każdą funkcję.',
        },
        {
            id: 'd',
            ...
            correct: false,
            explanation:
                'Jeśli nie podamy inicjalizatora, są zerowane zgodnie ze standardem.',
        },
    ]}
/>
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                '25 byłoby poprawne, gdyby A było makrem o wartości (2+3).',
        },
        {
            id: 'b',
            text: '11',
            correct: true,
            explanation:
                'Makro rozwija się do 2+3 * 2+3 = 2 + (3*2) + 3 = 2 + 6 + 3 = 11.',
        },
        {
            id: 'c',
            ...
            correct: false,
            explanation:
                'To zwykłe rozszerzenie makra — kod się poprawnie kompiluje.',
        },
        {
            id: 'd',
            text: '0',
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'Standard zabrania aliasowania różnych typów z wyjątkiem wyjątków — to łamie strict aliasing.',
        },
        {
            id: 'b',
            ...
            correct: true,
            explanation:
                'Tak — reinterpretacja pamięci int jako float narusza zasady aliasingu.',
        },
        {
            id: 'c',
        ...
        },
        {
            ...
            correct: false,
            explanation:
                'Kod się kompiluje — problem ujawnia się dopiero w czasie wykonania.',
        },
    ]}
/>
...
<QuizQuestion
    ...
    options={[
        ...
        },
        {
            ...
            correct: true,
            explanation:
                'mod1 nie zmienia oryginału (kopiowana wartość), mod2 modyfikuje przez wskaźnik.',
        },
        {
            id: 'c',
            text: '20',
...
<QuizQuestion
    ...
    options={[
        ...
        },
        {
            ...
            correct: true,
            explanation:
                'Najczęściej char + padding + int + char + padding daje 12 bajtów.',
        },
        {
            id: 'c',
            text: '1 bajt',
...
<QuizQuestion
    ...
    options={[
        ...
        },
        {
            ...
            correct: true,
            explanation:
                'i zlicza: 0 → 2 → 4 → koniec. Pętla wykona się 3 razy.',
        },
        {
            id: 'c',
            text: '2',
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'static zaczyna od 0, ale ++x inkrementuje przed zwróceniem.',
        },
        {
            id: 'b',
            text: '1, 2, 3',
            correct: true,
            explanation:
                'static pamięta wartość między wywołaniami — ++x daje sekwencję 1, 2, 3.',
        },
        {
            id: 'c',
            text: '1, 1, 1',
    ...
    options={[
        {
            ...
            correct: false,
            explanation:
                'Tablica „zanika” do wskaźnika — deklaracja jest myląca.',
        },
        {
            id: 'b',
...
<QuizQuestion
    ...
    options={[
        ...
        },
        {
            ...
            correct: false,
            explanation:
                'To zależy od kolejności ewaluacji, której standard nie określa.',
        },
        {
            id: 'c',
            text: 'Zachowanie jest nieokreślone.',
            correct: true,
            explanation:
                'Argumenty funkcji mogą być obliczone w dowolnej kolejności -> UB.',
        },
        {
            id: 'd',
...
<QuizQuestion
    ...
    options={[
        ...
        {
            id: 'd',
            text: 'Zachowanie nie jest określone przez standard',
            correct: true,
        },
    ]}
/>
...
<QuizQuestion
    ...
    options={[
        ...
        {
            id: 'b',
            text: 'Jest niepoprawna – kompilator powinien zgłosić błąd',
            correct: true,
        },
        {
            id: 'c',
            text: 'Jest poprawna, ale skutkuje nieokreślonym zachowaniem',
            correct: false,
        },
        {
            id: 'd',
            text: 'Jest poprawna tylko jeśli x jest const',
            correct: false,
        },
    ]}
/>
...
<QuizQuestion
    question="Jaka będzie wartość x po wykonaniu kodu?"
    multiple={false}
    options={[
        { id: 'a', text: '50', correct: false },
        { id: 'b', text: '51', correct: true },
        { id: 'c', text: '52', correct: false },
        { id: 'd', text: 'Zachowanie nieokreślone', correct: false },
    ]}
/>
...
<QuizQuestion
  question="Jaką wartość przyjmie zmienna y?"
  multiple={false}
  options={[
    {
      id: 'a',
      text: '9',
      correct: true,
      explanation: "++p przesuwa wskaźnik na t[1], więc *(*p)=3, a (*(p+1))[1]=6 — razem 9."
    },
    ...
    { id: 'c', text: '7', correct: false },
    {
      ...
      correct: false,
      explanation: `
W tym wyrażeniu nie dochodzi do UB:
- p jest modyfikowane tylko raz (preinkrementacja ++p), a później już wyłącznie odczytywane; nie ma sytuacji typu „jednoczesna modyfikacja i użycie starej wartości” jak w i = i++ + i;
- po ++p wskaźnik nadal wskazuje na element tej samej tablicy (t[1]), więc zarówno p, jak i p+1 mieszczą się w zakresie tablicy t;
- dereferencje *p, *(p+1) oraz indeks [1] odwołują się do istniejących elementów (tablica ma dokładnie 2 kolumny).

      Dlatego zachowanie jest dobrze zdefiniowane, a wynik wyrażenia jest deterministyczny.
...
<QuizQuestion
    question="Ile wyniesie x po wykonaniu kodu?"
    multiple={false}
    options={[
...
<QuizQuestion
    question="Jaką wartość będzie mieć zmienna diff?"
    multiple={false}
    options={[
...
<QuizQuestion
    question="Jakie będą końcowe wartości zmiennych x i y?"
    multiple={false}
    options={[
        { id: 'a', text: 'x = 1, y = 10', correct: true },
        { id: 'b', text: 'x = 10, y = 2', correct: false },
        { id: 'c', text: 'x = 10, y = 10', correct: false },
        { id: 'd', text: 'x = 1, y = 2', correct: false },
    ]}
/>
...
<QuizQuestion
    question="Jaka wartość zostanie przypisana do zmiennej z?"
    multiple={true}
    options={[
        { id: 'a', text: '3', correct: false },
...
<QuizQuestion
    question="Jakie będą wartości a i b po wykonaniu kodu?"
    multiple={false}
    options={[
        { id: 'a', text: 'a = 13, b = 8', correct: true },
        { id: 'b', text: 'a = 5, b = 13', correct: false },
        { id: 'c', text: 'a = 8, b = 8', correct: false },
        { id: 'd', text: 'a = 13, b = 13', correct: false },
    ]}
/>
...
int *p = tab;
int *q = tab + 1;
int res = (p == &tab[0]) + (q == p + 1);
```

<QuizQuestion
    question="Jaką wartość przyjmie zmienna res?"
    multiple={false}
    options={[
...
<QuizQuestion
    question="Jaką wartość ma zmienna val w typowej implementacji?"
    multiple={false}
    options={[
        ...
        {
            id: 'd',
            text: 'Zachowanie nieokreślone według standardu',
            correct: false,
        },
    ]}
/>
...
<QuizQuestion
    question="Jak oceniasz powyższy kod z punktu widzenia standardu C?"
    multiple={false}
    options={[
        {
            id: 'a',
            text: 'Kod jest poprawny i x będzie równy 99',
            correct: true,
        },
        {
            id: 'b',
            text: 'Kod jest niepoprawny, bo nie można przypisać pp do vp',
            correct: false,
        },
        {
            id: 'c',
            text: 'Kod jest niepoprawny, bo nie można rzutować void na int wskaźnikowy',
            correct: false,
        },
        {
            id: 'd',
            text: 'Kod zawsze prowadzi do zachowania nieokreślonego',
            correct: false,
        },
    ]}
/>

# Hardcore C – bez wskaźników, z wieloma poprawnymi odpowiedziami
...
<QuizQuestion
    question="Które stwierdzenia o zmiennych x, y, a, b, c są prawdziwe po wykonaniu kodu?"
    multiple={true}
    options={[
        {
            id: 'a',
            ...
            correct: true,
            explanation:
                'a++ używa wartości 1, b += c daje 5, więc x = 1 + 5 = 6.',
        },
        {
            id: 'b',
            text: 'y ma wartość 10',
            correct: true,
            explanation: 'Po a++ mamy a=2, b=5, c=3, więc y = 2 + 5 + 3 = 10.',
        },
        {
            id: 'c',
            text: 'a ma wartość 2',
            correct: true,
            explanation:
                'Postinkrementacja a++ zwiększa a z 1 do 2 po użyciu dawnej wartości w wyrażeniu.',
        },
        {
            id: 'd',
            text: 'b ma wartość 2',
            correct: false,
            explanation: 'b zostało zwiększone: b += c, czyli 2 + 3 = 5.',
        },
    ]}
/>
...
```c
unsigned int u1 = 10u;
unsigned int u2 = 0u - 1u;
int s1 = -1;
int s2 = (int)u2;
```

<QuizQuestion
    question="Które stwierdzenia są zgodne ze standardem C dla powyższego kodu?"
    multiple={true}
    options={[
        {
            id: 'a',
            text: 'u2 ma największą możliwą wartość typu unsigned int',
            correct: true,
            explanation:
                '0u - 1u w unsigned zawija się do maksymalnej wartości tego typu.',
        },
        {
            id: 'b',
            text: 'Wyrażenie 0u - 1u nie powoduje nieokreślonego zachowania',
            correct: true,
            explanation:
                'Dla unsigned arytmetyka jest zdefiniowana modulo 2 do potęgi szerokości typu.',
        },
        {
            id: 'c',
            text: 's1 i s2 muszą mieć tę samą wartość na każdej implementacji',
            correct: false,
            explanation:
                'Rzutowanie dużej wartości unsigned na int może dać różne wyniki w zależności od rozmiaru i reprezentacji int.',
        },
        {
            id: 'd',
            text: 'Konwersja u2 do int może być implementacyjnie określona, ale nie jest nieokreślona według standardu',
            correct: true,
            explanation:
                'Standard definiuje konwersję do typu całkowitego większego zakresu, ale przy przepełnieniu wyniki są implementacyjne, nie nieokreślone.',
        },
    ]}
/>
...
<QuizQuestion
    question="Które stwierdzenia o r1, r2, r3 są prawdziwe?"
    multiple={true}
    options={[
        {
            id: 'a',
            text: 'r1 i r2 mają identyczną wartość',
            correct: true,
            explanation:
                '&& ma wyższy priorytet niż ||, więc r1 i r2 są równoważne.',
        },
        {
            id: 'b',
            text: 'r1 ma wartość 1',
            correct: true,
            explanation:
                'a jest 0, więc a && b jest 0, 0 || c daje 1, ponieważ c jest niezerowe.',
        },
        {
            id: 'c',
            text: 'r3 ma wartość 0',
            correct: false,
            explanation:
                'b || c jest true (1), ale a && 1 daje 0, jednak wynik r3 to 0, więc to zdanie byłoby prawdziwe – tu jest pułapka: r3 faktycznie wynosi 0.',
        },
        {
            id: 'd',
            text: 'r3 ma wartość 0, ale wyrażenie b || c nie jest w ogóle obliczane',
            correct: false,
            explanation:
                'Wyrażenie b || c jest obliczane, ponieważ lewy operand operatora && (a) jest w tym miejscu wciąż brany pod uwagę zgodnie z pełną strukturą wyrażenia; pułapka polega na mieszaniu priorytetu i short-circuit w innym miejscu.',
        },
    ]}
/>
...
int s1 = sizeof t;
int s2 = sizeof t[0];
int s3 = sizeof t / sizeof t[0];
```

<QuizQuestion
    question="Które stwierdzenia dotyczące s1, s2, s3 są zgodne z C?"
    multiple={true}
    options={[
        {
            id: 'a',
            text: 's1 jest wielokrotnością s2',
            correct: true,
            explanation:
                's1 to rozmiar całej tablicy, s2 to rozmiar elementu, więc s1 = 5 * s2.',
        },
        {
            id: 'b',
            text: 's3 jest liczbą elementów tablicy t',
            correct: true,
            explanation:
                'To klasyczny wzór: sizeof tablicy przez sizeof elementu.',
        },
        {
            id: 'c',
            text: 's3 ma wartość 5 na każdej implementacji zgodnej ze standardem',
            correct: true,
            explanation:
                'Tablica ma 5 elementów, rozmiar typu int może się zmieniać, ale ich liczba nie.',
        },
        {
            id: 'd',
            text: 'sizeof t zwróci 5 na większości implementacji',
            correct: false,
            explanation:
                'sizeof t zwróci liczbę bajtów, zazwyczaj większą niż 5, np. 20 dla 4-bajtowego int.',
        },
    ]}
/>
...
<QuizQuestion
    question="Które stwierdzenia o r1, r2 i y są prawdziwe po wykonaniu kodu?"
    multiple={true}
    options={[
        {
            id: 'a',
            ...
            correct: true,
            explanation:
                'x jest niezerowe, więc x || cokolwiek daje 1, bez ewaluacji prawego argumentu.',
        },
        {
            id: 'b',
            text: 'r2 ma wartość 1',
            correct: true,
            explanation:
                'x jest niezerowe, więc lewy operand && jest true, ale z powodu short-circuit prawe wyrażenie nie jest obliczane; wynik to nadal 1.',
        },
        {
            id: 'c',
            text: 'y pozostaje równe 0 po obu przypisaniach',
            correct: true,
            explanation:
                'Z powodu krótkiego spięcia ani (y = 10), ani (y = 20) nie jest wykonane, więc y pozostaje 0.',
        },
        {
            id: 'd',
            text: 'Drugie wyrażenie (x && (y = 20)) zawsze ustawi y na 20, jeśli x jest niezerowe',
            correct: false,
            explanation:
                'W praktyce y nie jest ustawiane, bo r2 jest true już po ewaluacji x, a operator && nie musi ewaluować prawego operand.',
        },
    ]}
/>
...
<QuizQuestion
    question="Które stwierdzenia o wartości r są poprawne?"
    multiple={true}
    options={[
        {
            id: 'a',
            text: 'Operator warunkowy ?: łączy się prawostronnie',
            correct: true,
            explanation:
                'W C operator ?: ma łączność prawostronną, więc wyrażenie grupuje się jako a ? b : (c ? a + b : a + c).',
        },
        {
            id: 'b',
            text: 'r będzie równe 2',
            correct: true,
            explanation:
                'Ponieważ a jest niezerowe, wyrażenie wybiera bezpośrednio b, pomijając resztę.',
        },
        {
            id: 'c',
            text: 'Część c ? a + b : a + c nie jest w ogóle obliczana',
            correct: true,
            explanation:
                'Ze względu na krótkie spięcie operatora warunkowego, gdy a jest true, gałąź else nie jest ewaluowana.',
        },
        {
            id: 'd',
            text: 'r będzie równe 4, bo wyrażenie liczy a + b',
            correct: false,
            explanation:
                'To kuszące, ale wcale nie dochodzi do obliczenia a + b w części else, bo if-branch już wybiera b.',
        },
    ]}
/>
