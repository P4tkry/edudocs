...
> [!NOTE]
>
> Jeżeli warunek jest od początku fałszywy — kod wewnątrz pętli **nie
> wykona się ani razu**.
...
> [!NOTE]
>
> Od **C99** można deklarować zmienne licznika _bezpośrednio_ w nagłówku
...
> [!NOTE]
>
> Nadużywanie `break` i `continue` prowadzi do mniej czytelnego kodu,
...
> [!NOTE]
>
> Zaleca się ostrożność — jeśli pętla nie ma poprawnego warunku
...
> [!NOTE]
>
> `scanf` **zwraca liczbę poprawnie wczytanych argumentów** — zawsze
> trzeba to sprawdzać, jeżeli chcemy wiedzieć, czy użytkownik podał już nam wszystkie dane.
